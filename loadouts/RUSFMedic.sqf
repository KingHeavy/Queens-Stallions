...
_unit "_i" from 1 to 10 do {this addItemToUniform "ACE_elasticBandage";};
...
for "_i" from 1 to 4 do {this addItemToVest "hlc_30Rnd_545x39_S_AK";};
...
for "_i" from 1 to 30 do {this addItemToBackpack "ACE_packingBandage";};
...
for "_i" from 1 to 2 do {this addItemToBackpack "CUP_8Rnd_9x18_MakarovSD_M";};
